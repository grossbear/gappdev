...
#define WND_CLASS_NAME              "AppWindow"
...
/////////////////////////////////////////////////////////////////////////////////////////////
CWin32AppWindow::CWin32AppWindow(HINSTANCE hInstance):
m_hInstance(hInstance),m_hWnd(NULL),m_hDC(NULL),mWidth(0),mHeight(0)
{
    memset(&m_WndClass, 0, sizeof(WNDCLASSEX));
    memset(m_tstrWindowsClass, 0, WINDOW_CLASS_NAME_SIZE*sizeof(TCHAR));
    memset(m_tstrAppName, 0, APP_NAME_SIZE*sizeof(TCHAR));
}
/////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////
// Creating application window method
bool CWin32AppWindow::CreateAppWindow(const char *name, int width, int height)
{
    CopyAppNameString(name);
    memcpy(m_tstrWindowsClass,_T(WND_CLASS_NAME),sizeof(TCHAR)*sizeof(_T(WND_CLASS_NAME)));
    
    mWidth = (width < 2) ? (DEFAULT_WIDTH) : (width);
    mHeight = (height < 2) ? (DEFAULT_HEIGHT) : (height);

    //Registering Application Window Class
    if(!RegisterAppWindowClass())
    {
...
/////////////////////////////////////////////////////////////////////////////////////////////
LRESULT CALLBACK CWin32AppWindow::AppWinProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
...
/////////////////////////////////////////////////////////////////////////////////////////////
// Registering Application Window Class
BOOL CWin32AppWindow::RegisterAppWindowClass()
{
    WNDCLASSEX wndclass;
    ...
    wndclass.lpfnWndProc = (WNDPROC)CAppWindow::AppWinProc;    // WndProc Handles Messages
...
/////////////////////////////////////////////////////////////////////////////////////////////
// Creating Application Window
HWND CWin32AppWindow::CreateAppWindow()
{
    ...
    return CreateWindowEx(dwexStyle,    // Extended Style For The Window
        ...
        m_tstrAppName,                  // Window Title
        dwStyle,                        // Required Window Style
        CW_USEDEFAULT, CW_USEDEFAULT,   // Window Position
        mWidth, mHeight,                // Window width and height
...
/////////////////////////////////////////////////////////////////////////////////////////////
void CWin32AppWindow::CopyAppNameString(const char *name)
{
#ifdef UNICODE
    for (size_t i = 0; i < APP_NAME_SIZE - 1, name[i] != 0; i++)
        m_tstrAppName[i] = (TCHAR)name[i];
#else
    strcpy_s(m_tstrAppName, APP_NAME_SIZE, name);
#endif //UNICODE
}
/////////////////////////////////////////////////////////////////////////////////////////////
