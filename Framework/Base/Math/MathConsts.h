...
public:
    ...
    static constexpr T MATH_2PI        = T(CONST_2PI);         // - 2pi
    static constexpr T MATH_PI_2       = T(CONST_PI_2);        // - pi/2
    static constexpr T MATH_PI_4       = T(CONST_PI_4);        // - pi/4
    static constexpr T MATH_1_PI       = T(CONST_1_PI);        // - 1/pi
    static constexpr T MATH_2_PI       = T(CONST_2_PI);        // - 2/pi
    static constexpr T MATH_1_2PI      = T(CONST_1_2PI);       // - 1/2pi

    static constexpr T MATH_DEG2RAD    = T(CONST_DEG2RAD);     // - pi/180
    static constexpr T MATH_RAD2DEG    = T(CONST_RAD2DEG);     // - 180/pi (1 rad)

    static constexpr T MATH_SQRT_2     = T(CONST_SQRT_2);      // - sqrt(2)
    static constexpr T MATH_SQRT_1_2   = T(CONST_SQRT_1_2);    // - 1/sqrt(2)
    static constexpr T MATH_2_SQRTPI   = T(CONST_2_SQRTPI);    // - 2/sqrt(pi)

    static constexpr T MATH_E          = T(CONST_E);           // - e
    static constexpr T MATH_LOG2E      = T(CONST_LOG2E);       // - log2(e)
    static constexpr T MATH_LOG10E     = T(CONST_LOG10E);      // - log10(e)
    static constexpr T MATH_LN2        = T(CONST_LN2);         // - ln(2)
    static constexpr T MATH_LN10       = T(CONST_LN10);        // - ln(10)
    static constexpr T MATH_PHI        = T(CONST_PHI);         // - phi (Golden Number)
};
///////////////////////////////////////////////////////////////////////////////////////
